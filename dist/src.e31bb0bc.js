...
var scroller = function scroller() {
  ...
  var progressMax = Math.min(progress, 1);
...
var setTimeVars = function setTimeVars() {
  var now = new Date();
  var timeInMilliseconds = now.getTime() - now.getTimezoneOffset() * 60000;
  var minuteProgress = timeInMilliseconds / 1000 / 60 % 60;
  var hourProgress = timeInMilliseconds / 1000 / 60 / 60 % 24;
  var dayProgress = now.getHours() / 24 * 2;
